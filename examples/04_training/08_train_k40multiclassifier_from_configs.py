...
from graphnet.constants import (
    EXAMPLE_OUTPUT_DIR,  # Changed these all to: "/mnt/gs21/scratch/robsonj3/k40sim/results/"
    DATASETS_CONFIG_DIR,
    MODEL_CONFIG_DIR,
)
...
def main(
    ...
    if suffix is not None:
        archive = os.path.join("/mnt/gs21/scratch/robsonj3/k40sim/results/", f"train_model_{suffix}")
    else:
        archive = os.path.join("/mnt/gs21/scratch/robsonj3/k40sim/results/", "train_model")
...
if __name__ == "__main__":
    ...
    parser.with_standard_arguments(
        ...
        (
            "model-config",
            os.path.join(
                MODEL_CONFIG_DIR, "dynedge_PID_classification_example.yml"  # Probably need to change this line
            ),
        ),
        "gpus",
        ("max-epochs", 1),
